		...
		<div id="addAll">
			...
			<script type="text/javascript">
				function fileChange(){//注意：此处不能使用jQuery中的change事件，因此仅触发一次，因此使用标签的：onchange属性
					...
					$.ajaxFileUpload({
						url: '/ajaxImg.action',//用于文件上传的服务器端请求地址
						...
						success: function(obj) //服务器成功响应处理函数
						{
							...
							var imgObj = $("<img>");
							//给img标签对象追加属性
							imgObj.attr("src","/mimi-SSM-LGL/image_big/"+obj.imgurl);
				...
				<form action="${pageContext.request.contextPath}/prod/update.action" enctype="multipart/form-data" method="post" id="myform">
					...
					<table>
						...
						<tr>
							...
							<td> <br><div id="imgDiv" style="display:block; width: 40px; height: 50px;"><img src="/mimi-SSM-LGL/image_big/${prod.pImage}" width="100px" height="100px" ></div><br><br><br><br>
